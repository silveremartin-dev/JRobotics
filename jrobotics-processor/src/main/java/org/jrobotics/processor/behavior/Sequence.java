 ...
 * 
 * <p>Returns SUCCESS only if all children succeed. Returns FAILURE on first child failure.</p>
 * 
 ...
 * @since 2.0.0
 */
public class Sequence implements BehaviorNode {
     ...
     */
    public Sequence addChild(BehaviorNode child) {
        children.add(child);
        return this;
    }
