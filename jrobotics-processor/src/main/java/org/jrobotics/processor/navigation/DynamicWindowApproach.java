 ...
 * 
 * <p>
 * Computes velocity commands that navigate toward goal while
 * avoiding obstacles using a sampled velocity space search.
 * </p>
 * 
 * <p>
 * <b>Algorithm:</b>
...
public class DynamicWindowApproach {
    ...
    public void setMaxAngularVelocity(double maxW) {
        this.maxW = maxW;
    }
