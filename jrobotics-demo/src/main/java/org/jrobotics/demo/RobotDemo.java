 ...
 * 
 * <p>This demo creates a simulated differential drive robot with sensors
 * and actuators, then demonstrates basic robot operations.</p>
 * 
...
public class RobotDemo {
    ...
    private static void runDemo() throws Exception {
        ...
        distance.ifPresent(d -> 
            System.out.println("  ├─ Front sonar: " + String.format(Locale.US, "%.3f", d) + " m"));
