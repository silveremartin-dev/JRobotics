...
class RobotSimulationIntegrationTest {
    ...
    void testPhysicsSimulationStep() {
        ...
        PhysicsBody robot = PhysicsBody.dynamic("testBot", 
            new Vector3(0, 0, 0),
    ...
    void testDefaultPhysicsEngine() {
        ...
        // Add two bodies
        world.addBody(PhysicsBody.dynamic("a", new Vector3(0, 0, 0), Vector3.ZERO, 1.0));
        world.addBody(PhysicsBody.dynamic("b", new Vector3(1.5, 0, 0), Vector3.ZERO, 1.0));
