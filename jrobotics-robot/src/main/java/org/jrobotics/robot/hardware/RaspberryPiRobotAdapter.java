 ...
 * 
 * <p>For robots with Raspberry Pi as the main controller, using HATs like:
 * Motor HAT, PiCAN, Sense HAT, etc.</p>
 * 
...
public class RaspberryPiRobotAdapter implements RobotHardwareAdapter {
    ...
    public enum Hat { MOTOR_HAT, ADAFRUIT_DC_STEPPER, WAVESHARE_MOTOR, NONE }
    ...
    public boolean readGpio(int pin) {
        ...
        return halProvider.getSimulatedGpioPin(pin).read() 
                == org.jrobotics.hal.GpioPin.State.HIGH;
    }
